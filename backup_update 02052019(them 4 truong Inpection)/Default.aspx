            ...
            <div>
                <div style="float: left; width: 740px;">
                    <div class="form-group">
                        <label for="location" style="color: RGB(0,87,137)">Tìm kiếm theo</label>
                    ...
                    <div class="form-group">
                        <label for="location" style="color: RGB(0,87,137)">Giá trị</label>
                        <asp:TextBox ID="txtQCode" ClientIDMode="Static" runat="server" CssClass="form-control" Width="160px"></asp:TextBox>
                    </div>
                                        ...
                                        <div style="width: 650px;">
                                            ...
                                            <div style="width: 420px; float: left;" id="dvother">
                                                ...
                                                <div style="width: 120px; margin-left: 5px">
                                                    <input type="text" id="txtNote1" class="form-control" /></div>
                                            </div>
                                        ...
                                        <div style="width: 500px;">
                                            ...
                                            <div style="width: 300px; float: left;" id="dvRemark">
                                                <div style="width: 200px; margin-left: 5px">
                                                    <input type="text" id="txtRemark2" class="form-control" /></div>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
