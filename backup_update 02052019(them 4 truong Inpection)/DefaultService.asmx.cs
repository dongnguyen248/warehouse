...
namespace MaterialManagement
{
    ...
    public class DefaultService : System.Web.Services.WebService
    {
        ...
        public int Insert(string QCode, string Zone, string Location, string Item, string Spec, string Unit, string Qty, string Price, string Po, string Remark, string Pur_Date, string Supplier, string Buyer, string Receiver, string Get, string locator)
        {
            ...
            if (CheckQCode(QCode))
            {
                Import_His(QCode, Pur_Date, Qty, Price, Po, Supplier, Buyer, Receiver, Get, UserID,locator);
        ...
        [WebMethod]
        public int Update(int ID, string QCode, string Zone, string Location, string Item, string Spec, string Unit, string Qty, string Price, string Remark, string Pur_Date)
        {
      ...
      {
          string UserID = HttpContext.Current.Session["USERNAME"].ToString();
          Import_His(QCode, Imp_date, txtQty, txtPrice, Po, txtImp_Supplier, txtImp_Buyer, txtImp_Receiver, Get, UserID,locator);
          return 1;
      }
        [WebMethod]
