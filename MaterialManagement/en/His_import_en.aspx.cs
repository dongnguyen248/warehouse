...
{
    public partial class His_import_en : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (Session["USERNAME"] != null && userid != "admin")
            {
                sql = " select Seq,m.QCODE,i.Pur_Date,m.ITEM,m.SPEC,Round(sum(i.Quantity),2) 'Quantity',Round(i.Price,2)as Price,Po,Supplier,Buyer,Receiver,Allocated,i.Remark from dbo.MATERIAL m, dbo.Import_History i where m.qcode = i.qcode " + dk + " and (i.userid=@userid or i.userid is null) group by Seq,m.QCODE,m.ITEM,m.SPEC,m.UNIT,i.Pur_Date,i.Price,Po,Supplier,Buyer,Receiver,Allocated,i.Remark ";
                param.Add("@userid", userid);
            }
            else
            {
        ...
        protected void dropNhaCC_SelectedIndexChanged(object sender, EventArgs e)
        {
