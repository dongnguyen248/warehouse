    ...
    $.fn.fixedHeaderTable = function (method) {
        ...
        var helpers = {
            ...
            _setupFixedColumn: function ($obj, obj, tableProps) {
                ...
                $tbody = $('<div class="fht-tbody" id="test"><table class="fht-table" id="sang"><tbody></tbody></table></div>'),
            ...
            _isPaddingIncludedWithWidth: function () {
                var $obj = $('<table class="fht-table"><tr><td style="padding: 10px; font-size: 12px;">test</td></tr></table>'),
            	defaultHeight,
            	newHeight;
                ...
                if (!scrollbarWidth) {
                    if ($.browser.msie) {
                        ...
                        $textarea2 = $('<textarea cols="10" rows="2" style="overflow: hidden;"></textarea>')
                            .css({ position: 'absolute', top: -1000, left: -1000 }).appendTo('body');
                        scrollbarWidth = $textarea1.width() - $textarea2.width() + 1; // + 2 for border offset
